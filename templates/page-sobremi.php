...
<main class="sobremi-main">
	...
	<section class="sobremi-intro" aria-label="<?php esc_attr_e('Introducción', 'avance-template'); ?>">
		<div class="sobremi-intro__container">
			<!-- Content Group -->
			<div class="sobremi-intro__content">
				<picture class="sobremi-intro__image">
					<source media="(max-width: 479px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/assets/images/MiMobil.png'); ?>">
					<source media="(min-width: 480px)" srcset="<?php echo esc_url(get_template_directory_uri() . '/assets/images/PlaceholderImg.png'); ?>">
					<img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/PlaceholderImg.png'); ?>" alt="<?php esc_attr_e(bloginfo('name'), 'avance-template'); ?>" class="sobremi-intro__image-img" loading="lazy" width="400" height="460">
				</picture>
				<div class="sobremi-intro__text">
					<ul class="sobremi-intro__list">
						<li class="sobremi-intro__list-item"><?php esc_html_e('MBA — Universidad ESAN', 'avance-template'); ?></li>
						<li class="sobremi-intro__list-item"><?php esc_html_e('Consultor certificado', 'avance-template'); ?></li>
						<li class="sobremi-intro__list-item"><?php esc_html_e('+200 empresas asesoradas', 'avance-template'); ?></li>
						<li class="sobremi-intro__list-item"><?php esc_html_e('+15 años de experiencia', 'avance-template'); ?></li>
						<li class="sobremi-intro__list-item"><?php esc_html_e('Speaker internacional', 'avance-template'); ?></li>
					</ul>
				</div>
				<div class="sobremi-intro__button">
					<div class="sobremi-intro__socials">
						<a href="https://linkedin.com" class="sobremi-intro__social-link" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
						...
						<a href="https://instagram.com" class="sobremi-intro__social-link" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
						...
						<a href="https://youtube.com" class="sobremi-intro__social-link" aria-label="YouTube" target="_blank" rel="noopener noreferrer">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
			...
			<div class="sobremi-intro__features">
				...
				<div class="sobremi-intro__stat">
					...
					<p class="sobremi-intro__stat-text"><?php esc_html_e('Transformo equipos comerciales B2B con más de 20 años de experiencia gerencial en Perú y el extranjero, liderando ventas para empresas como Komatsu, Nestlé, Telefónica, BCP y BBVA.', 'avance-template'); ?></p>

					<p class="sobremi-intro__stat-text"><?php esc_html_e('Magíster en Marketing (UPC), con programas en ESADE, Adolfo Ibáñez y ESAN, y certificación de coach por John Maxwell. Fundador de Avance, docente en Pacífico Business School y conductor de "Esto es Ventas B2B".', 'avance-template'); ?></p>
				...
				<div class="sobremi-intro__achievement">
					...
					<div class="sobremi-intro__achievement-buttons">
						<a href="<?php echo esc_url(get_permalink(get_page_by_path('contacto')) . '#scheduling-section'); ?>" class="sobremi-intro__achievement-btn sobremi-intro__achievement-btn--primary"><?php esc_html_e('Agendar sesión', 'avance-template'); ?></a>
