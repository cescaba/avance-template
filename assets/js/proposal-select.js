...
class ProposalSelect {
	...
	selectOption(option) {
		...
		this.hiddenSelect.setAttribute('value', value);
		...
		// Trigger change event DESPUÉS de todo
		setTimeout(() => {
...
document.addEventListener('DOMContentLoaded', () => {
	const trigger = document.getElementById('proposal-select-trigger');
	const dropdown = document.getElementById('proposal-select-dropdown');
	const select = document.getElementById('proposal-servicio');

	if (trigger && dropdown && select) {
		new ProposalSelect('proposal-select-trigger', 'proposal-select-dropdown', 'proposal-servicio');
	}
});
