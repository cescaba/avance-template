...
class Avance_Agendamiento_Sesiones_Handler {
	...
	public static function process($data) {
		// Guardar en la BD
		$agendamiento_id = Avance_Agendamiento_Sesiones_DB::save_agendamiento($data);
		...
		Avance_Agendamiento_Sesiones_DB::update_status($agendamiento_id, 'confirmado');
