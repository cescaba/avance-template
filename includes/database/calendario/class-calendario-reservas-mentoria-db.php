<?php
/**
 * Calendario Reservas Mentoría Database
 *
 * Tabla específica para disponibilidad de mentoría
 *
...
class Avance_Calendario_Reservas_Mentoria_DB {

	private static $table_name = 'avance_calendario_reservas_mentoria';
