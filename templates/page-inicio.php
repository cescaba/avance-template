		...
		<div class="home-hero__bg" style="background-image: url('<?php echo esc_url(get_template_directory_uri() . '/assets/images/Rectangle 3.png'); ?>')">
			<div class="home-hero__container">
				...
				<div class="home-hero__bottom">
					<p class="home-hero__description"><?php esc_html_e('Capacitación ejecutiva, consultoría comercial y mentoría para líderes que quieren resultados concretos en Lima y el Peraº.', 'avance-template'); ?></p>
	...
	<section class="home-features" aria-label="<?php esc_attr_e('Características', 'avance-template'); ?>">
		<div class="home-features__container animate-on-scroll" data-animate>
			<div class="home-features__item">
				<span class="home-features__stat counter animate-on-scroll" data-animate data-value="50" data-suffix="+">0</span>
				<p class="home-features__text"><?php esc_html_e('Empresas asesoradas', 'avance-template'); ?></p>
			</div>
			<div class="home-features__item">
				<span class="home-features__stat counter animate-on-scroll" data-animate data-value="35" data-suffix="+">0</span>
				<p class="home-features__text"><?php esc_html_e('Años de experiencia', 'avance-template'); ?></p>
			</div>
			<div class="home-features__item">
				<span class="home-features__stat counter animate-on-scroll" data-animate data-value="100" data-suffix="%">0</span>
			...
			<div class="home-process__list">
				...
				<div class="home-process__item animate-on-scroll" data-animate>
					...
					<div class="home-process__content">
						...
						<p class="home-process__item-text"><?php esc_html_e('Diseñamos un programa específico: capacitación, consultoría o mentoría segaºn tu necesidad.', 'avance-template'); ?></p>
					</div>
				</div>
				<div class="home-process__item animate-on-scroll" data-animate>
				...
				<article class="home-testimonials__item animate-on-scroll" data-animate>
					...
					<div class="home-testimonials__author">
						...
						<div class="home-testimonials__author-content">
							...
							<p class="home-testimonials__role"><?php esc_html_e('Gerente Comercial â€” Retail, Lima', 'avance-template'); ?></p>
						</div>
					</div>
				</article>
				<article class="home-testimonials__item animate-on-scroll" data-animate>
				...
				<div class="contacto-agenda__left">
					...
					<div class="contacto-agenda__card">
						<div class="contacto-agenda__cal-header">
							<button class="contacto-agenda__cal-nav" id="contactoAgendaPrevMonth" aria-label="<?php esc_attr_e('Mes anterior', 'avance-template'); ?>">â€¹</button>
							<div class="contacto-agenda__cal-month-label" id="contactoAgendaMonthLabel"></div>
							<button class="contacto-agenda__cal-nav" id="contactoAgendaNextMonth" aria-label="<?php esc_attr_e('Mes siguiente', 'avance-template'); ?>">â€º</button>
						</div>
						<div class="contacto-agenda__cal-grid" id="contactoAgendaCalGrid">
							...
							<div class="contacto-agenda__cal-weekday"><?php esc_html_e('MIa‰', 'avance-template'); ?></div>
							...
							<div class="contacto-agenda__cal-weekday"><?php esc_html_e('SaB', 'avance-template'); ?></div>
						</div>
						<div class="contacto-agenda__tz-row">ðŸ• Lima (GMT-5)</div>
					</div>
				</div>
